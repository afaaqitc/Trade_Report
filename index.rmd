...
select(c(1,6,5,7,2,3,4,8))


main_dt<-
main %>% datatable(class = "hover cell-borders",
extensions =list(Buttons=TRUE) ,options = list(dom="Bfrtip",buttons=c("excel","csv","pdf"))) %>% 
formatPercentage(columns = c(4,8),digits = 2) %>% 
formatCurrency(columns = c(2,3),digits = 2)
...
month_week_totals %>% 
datatable(class = "hover cells-border strip",
...
daily_total_trades %>% datatable(filter = "top",class = "hover cells-border strip",
extensions = list(Buttons=TRUE,RowGroup=TRUE),
...
datatable(class="hover cell-borders strip",extensions = list(Buttons=TRUE),
options = list(dom="Bfrtip",buttons=c("excel","csv","pdf"),
columnDefs=list(list(className="dt-center",targets=1:7)))) %>% 
formatPercentage(columns = c(5,7),digits = 2) %>% formatCurrency(columns = 6,digits = 2)
...
### Rounds
```{r}
valueBox(value = nrow(main),caption = "Rounds",icon ="fa fa-certificate"  ,color = "#b2bec3")
```


### profits
```{r}
valueBox(value =sum(qx$net) ,caption =" Profits",icon ="fa fa-money" ,color ="#b2bec3" )
```
### trades
```{r}
valueBox(value =sum(main$trades) ,caption ="Trades" ,color = "#b2bec3",icon ="fa fa-line-chart"  )
```


### days
```{r}
valueBox(value =nrow(daily_total_trades) ,caption ="Days" ,icon ="fa fa-calendar" ,color = "#b2bec3")
```
