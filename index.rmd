...
### Profits
```{r}
valueBox(value =sum(qx$net) ,caption ="Profits" ,icon ="fa fa-money" ,color ="#f1f2f6" )
```

### Days
```{r}
valueBox(value =sum(main$Trade_Days) ,caption = "Days",icon = "fa fa-calendar",color = "#f1f2f6")
```
