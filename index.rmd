...
### Rounds
```{r}
valueBox(value = nrow(main),caption = "Rounds",color = "#b2bec3")
```


### profits
```{r}
valueBox(value =sum(qx$net) ,caption =" Profits" ,color ="#b2bec3" )
```
### trades
```{r}
valueBox(value =sum(main$trades) ,caption ="Trades" ,color = "#b2bec3"  )
```


### days
```{r}
valueBox(value =nrow(daily_total_trades) ,caption ="Days" ,color = "#b2bec3")
```
