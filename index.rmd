...
main_dt<-
main %>% adorn_totals("row")%>%  datatable(class = "hover row-border strip ",
...
daily_total_trades %>% datatable(filter = "top",class = "hover row-border ",
extensions = list(Buttons=TRUE,RowGroup=TRUE),
...
### Profits
```{r}
valueBox(value =sum(qx$net) ,caption ="Profits" ,icon ="fa fa-money" ,color ="#feca57" )
```

### Days
```{r}
valueBox(value =sum(main$Trade_Days) ,caption = "Days",icon = "fa fa-calendar",color = "#feca57")
```
